...
1. Open **Code::Blocks** and create an empty file (`Ctrl+Shift+N`).
2. Paste the source code and save it as `multiplication_game.cpp`.
3. Press **F9** (Build and Run) to play.
