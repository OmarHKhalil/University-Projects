...
<body id="omar">
    ...
    <main class="" style="margin-top: 10rem;">
        ...
        <section class="products flex">
            <article class="a">
                <a href="product-details.html"><img src="picure/bmw/1.jpeg" alt="Not Found"></a>
                <div class="content">
                    <h1 class="title">Bmw Z4</h1>
            ...
            <article class="a">
                <a href="product-details.html"><img src="Picure/bmw/2.jpeg" alt="Not Found"></a>
                <div class="content">
                    <h1 class="title">Bmw i8 2024</h1>
                    <p class="descrip">It is known for its high off-road capability, iconic design and luxury</p>
                    <div class="flex">
                        <p class="price">$124400</p>
                        <button class="add"><img class="" src="picure/icon/cart-shopping-solid.svg"  alt="not found" style="width: 15px; height:15px">
                            Add to Cart</button>
                    </div>
                </div>
            ...
            <article class="a">
                <a href="product-details.html"><img src="Picure/bmw/3.jpeg"alt="Not Found"></a>
                <div class="content">
                    <h1 class="title">Bmw serri 4</h1>
            ...
            <article class="a">
                <a href="product-details.html"><img src="Picure/bmw/4.avif" alt="Not Found"></a>
                <div class="content">
                    <h1 class="title">Bmw iX 2022</h1>
            ...
            <article class="a">
                <a href="product-details.html"><img src="Picure/bmw/5.jpeg" alt="Not Found"></a>
                <div class="content">
                    <h1 class="title">Bmw 420i</h1>
            ...
            <section class="products flex">
                <article class="a">
                    <a href="product-details.html"><img src="Picure/bmw/6.jpeg" alt="Not Found"></a>
                    <div class="content">
                        <h1 class="title">Bmw supercar</h1>
        ...
        <div class="slider" >
            <img src="Picure/a2.jpg" alt="Image 1" height="150px" width="80%">
            <img src="Picure/a4.jpg" alt="Image 2" height="150px" width="80%">
            <img src="Picure/a7.jpg" alt="Image 3" height="150px" width="80%">
        </div>
        ...
        <?php
    include('connect.php');
    $result = mysqli_query($omar,"SELECT * FROM products WHERE type='bmw'");
    ...
    ?>
            ...
            <article class="a">
                <a href="product-details.html"><img src="Picure/bmw/7.jpeg" alt="Not Found"></a>
                <div class="content">
                    <h1 class="title">Bmw F30</h1>
                    <p class="descrip">A four-door sports coupe that combines elegance and performance at a reasonable cost</p>
                    <div class="flex">
            ...
            <article class="a">
                <a href="product-details.html"><img src="Picure/bmw/8.jpeg" alt="Not Found"></a>
                <div class="content">
                    <h1 class="title">Bmw 525</h1>
                    <p class="descrip">A four-door sports coupe that combines elegance and performance at a reasonable cost</p>
                    <div class="flex">
            ...
            <article class="a">
                <a href="product-details.html"><img src="Picure/bmw/9.jpeg" alt="Not Found"></a>
                <div class="content">
                    <h1 class="title">Bmw serie 1</h1>
            ...
            <article class="a">
                <a href="product-details.html"><img src="Picure/bmw/10.jpeg" alt="Not Found"></a>
                <div class="content">
                    <h1 class="title">Bmw X7 2023</h1>
            ...
            <article class="a">
                <a href="product-details.html"><img src="Picure/bmw/11.webp" alt="Not Found"></a>
                <div class="content">
                    <h1 class="title">Bmw iX 2024</h1>
                    <p class="descrip">A small car, but it comes with the high-tech features that Mercedes is known for</p>
                    <div class="flex">
                        <p class="price">$120000</p>
                        <button class="add"><img class="" src="picure/icon/cart-shopping-solid.svg"  alt="not found" style="width: 15px; height:15px">
            ...
            <article class="a">
                <a href="product-details.html"><img src="Picure/bmw/12.jpeg" alt="Not Found"></a>
                <div class="content">
                    <h1 class="title">Bmw X5 M 2022</h1>
