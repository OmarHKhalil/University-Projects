...
<head>
    ...
    <title>AOK Company Mercedes</title>
...
<a id="omar1" href="#omar" ><img src="picure/icon/check-double-solid.svg" alt="not found" height="25px" width="25px"></a>
    <main class="" style="margin-top: 10rem;">
        <section class="head">
                <ul class="nav">
                    <li><img src="picure/icon/check-double-solid.svg" height="20px" width="20px" alt="not found"></li>
                    <li class="menu"><h1 >Mercedes-Benz</h1>
                    <ul class="submenu">
        ...
        <section class="products flex">
            <article class="a">
                <a href="product-details.html"><img src="Picure/13.jpg" alt="Not Found"></a>
                <div class="content">
                    <h1 class="title">Mercedes A</h1>
            ...
            <article class="a">
                <a href="product-details.html"><img src="Picure/2.jpg" alt="Not Found"></a>
                <div class="content">
                    <h1 class="title">Mercedes CLA</h1>
                    <p class="descrip">A four-door sports coupe that combines elegance and performance at a reasonable cost</p>
                    <div class="flex">
                        <p class="price" style="color:black">$120000</p>
                        <button class="add" style="background-color: rgb(255, 228, 74);color: black;"><img class="" src="picure/icon/cart-shopping-solid.svg"  alt="not found" style="width: 15px; height:15px">
                            Add to Cart</button>
                    </div>
                </div>
            </article>
            ...
            <article class="a">
                <a href="product-details.html"><img src="Picure/3.webp" alt="Not Found"></a>
                <div class="content">
                    <h1 class="title">Mercedes AMG GT</h1>
            ...
            <article class="a">
                <a href="product-details.html"><img src="Picure/10.jpg" alt="Not Found"></a>
                <div class="content">
                    <h1 class="title">Mercedes GLC</h1>
            ...
            <article class="a">
                <a href="product-details.html"><img src="Picure/5.jpg" alt="Not Found"></a>
                <div class="content">
                    <h1 class="title">Mercedes A-Class 2019</h1>
            ...
            <article class="a">
                <a href="product-details.html"><img src="Picure/6.jpg" alt="Not Found"></a>
                <div class="content">
        ...
        <div class="slider">
            ...
            <img src="picure/a4.jpg" alt="Image 2" height="150px" width="80%">
            <img src="picure/a8.jpg" alt="Image 3" height="150px" width="80%">
        </div> 
        <section class="products flex">

        <?php
    include('connect.php');
    $result = mysqli_query($omar,"SELECT * FROM products WHERE type='mer'");
    ...
    ?>
            ...
            <article class="a">
                <a href="product-details.html"><img src="Picure/8.jpg" alt="Not Found"></a>
                <div class="content">
                    <h1 class="title">Mercedes GLS</h1>
            ...
            <article class="a">
                <a href="product-details.html"><img src="Picure/7.jpg" alt="Not Found"></a>
                <div class="content">
                    <h1 class="title">Mercedes G-Class</h1>
            ...
            <article class="a">
                <a href="product-details.html"><img src="Picure/9.webp" alt="Not Found"></a>
                <div class="content">
                    <h1 class="title">Mercedes E-Class</h1>
            ...
            <article class="a">
                <a href="product-details.html"><img src="Picure/11.jpg" alt="Not Found"></a>
                <div class="content">
                    <h1 class="title">Mercedes Class E CLA</h1>
            ...
            <article class="a">
                <a href="product-details.html"><img src="Picure/12.jpg" alt="Not Found"></a>
                <div class="content">
                    <h1 class="title">Mercedes G</h1>
                    <p class="descrip">A four-door sports coupe that combines elegance and performance at a reasonable cost</p>
                    <div class="flex">
            ...
            <section class="products flex">
                <article class="a">
                    <a href="product-details.html"><img src="Picure/14.jpeg" alt="Not Found"></a>
                    <div class="content">
                        <h1 class="title">Mercedes EQS 2022</h1>
                        <p class="descrip">A small car, but it comes with the high-tech features that Mercedes is known for</p>
                        <div class="flex">
