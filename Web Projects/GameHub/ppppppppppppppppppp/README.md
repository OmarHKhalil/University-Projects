...
> University web programming project (WP course).
...
Before pushing, avoid committing build artifacts and IDE folders. A typical `.gitignore` for this project should exclude:

- `bin/`, `obj/`
- `.vs/`
- `*.user`, `*.suo`
- NuGet `packages/` (optional — restore on clone instead)

Keep `App_Data/*.mdf` only if you intend to share the database; otherwise document how to recreate schema locally.

## License

This project was created for educational purposes. Use and distribution are at your discretion; add a license file if you publish it publicly.

## Author

University WP course project — 2024.
